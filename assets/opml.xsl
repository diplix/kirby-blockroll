...
Browser stylesheet for OPML (page + directory).

Adapted from pfefferle/wordpress-blockroll templates/opml.xsl
(GPL-2.0-or-later): https://github.com/pfefferle/wordpress-blockroll
